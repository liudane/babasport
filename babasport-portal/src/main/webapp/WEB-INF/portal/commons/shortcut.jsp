...
function login(){
	...
	window.location.href = "http://localhost:8083/shopping/login.aspx?returnUrl=" + encodeURIComponent(window.location.href);
}
//页面加载就执行此方法, 判断用户是否登录
$(function(){
	$.ajax({
		url : "http://localhost:8083/shopping/isLogin.aspx",
		type : "post",
		dataType : "jsonp",
