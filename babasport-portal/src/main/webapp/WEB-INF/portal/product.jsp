...
var colorId;
var skuId;
//target:当前选中的对象, id:当前选中的颜色id
function colorToRed(target,id) {
	//给全局颜色赋值, 留着给下面选中尺码的方法来用
	colorId = id;
	//给所有颜色去掉选中的样式, 也就是将所有颜色的红框的样式去掉
